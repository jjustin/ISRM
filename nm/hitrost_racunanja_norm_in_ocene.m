...
% `norm`? V spremenljivko L shranite spodnjo mejo, v spremenljivko U pa
% zgornjo mejo.
% 
% Primerjajte cas racunanja norm za nakljucno 1000x1000 matriko.
% =============================================================================
...
function validation = validate_current_attempt_file(src)
  ...
  check_initialize(file_parts);
      ...
      if check_part()
        check.current_part.token = 'eyJwYXJ0IjoxODk0OCwidXNlciI6NDA0Nn0:1kazDF:mRiWu0wvny4GarcRoE_0AgktwlY';
        try
              check_equal('L', L);
  check_equal('U', U);
          catch err
