...
prepTermsLoop LDT @polytmp
	...
	J prepTermsLoop
endPrepTermsLoop JSUB stackpop
	LDL @stackptr
	RSUB
...
drawPoint STA @stackptr
	...
	LDA =42
	STCH @scrpos
drawPointEnd LDA @stackptr
	RSUB

. draws coord system
. draw down
drawCoord	LDA screen
	ADD =39
	CLEAR X
drawCoordLoop1 STA scrpos
	LDA =124 . |
	STCH @scrpos
	LDA scrpos
	ADD =80
