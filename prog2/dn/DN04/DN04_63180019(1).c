...
int main() {
    ...
    dolzinaVzorca = strlen(vzorcniNiz);
    ...
    for (int i = 0; i < stTestnihNizov; i++) {
        ...
        while (*pNiz != '\0') {
            ...
            //potem je dolzina niza lahko vecja od dolzine vzorcnega niza
                zvezdica = true;
                pVzorec++;
                while (*pNiz != '\0' || *pNiz != *pVzorec) {
                    pNiz++;
                    //pVzorec++;  pNiz premikam dokler ne pridem do enakega
                }
        ...
        //printf("%d \n", stIstihZnakov);
        if (dolzinaNiza < dolzinaVzorca && zvezdica == false) {
            seUjemata = false;
        } 
        ...
        else if(zvezdica == true && dolzinaNiza >= dolzinaVzorca && stIstihZnakov == dolzinaVzorca) {
            stUjemajocih++;
        }
       /*  if (seUjemata) {
            stUjemajocih++;
